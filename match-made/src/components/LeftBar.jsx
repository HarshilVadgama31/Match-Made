    ...
    return (
        <>
            <div className="flex h-full mb-10">
                <div className="flex flex-col relative place-content-between h-full w-24 rounded-br-xl rounded-tr-xl bg-card_light py-4 dark:bg-card_dark">
