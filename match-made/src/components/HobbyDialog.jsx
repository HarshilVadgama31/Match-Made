  ...
  return (
    <>
      ...
      <Dialog open={open} handler={handleOpen} className=" bg-card_light dark:bg-card_dark">
        ...
        <DialogBody divider className="h-[40rem] overflow-scroll bg-bg_light  dark:bg-bg_dark/70">
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <Typography className="font-medium text-bg_dark dark:text-bg_light">
                      {hobby}
                    </Typography>
                  </label>
                </ListItem>
        ...
        <DialogFooter className="space-x-2">
          ...
          <Button variant="solid" color="" onClick={handleHobbies} className="bg-button_light dark:bg-button_dark">
            Save changes
          </Button>
        </DialogFooter>
      </Dialog>
